...
@interface CollectionController ()<UICollectionViewDelegate,UICollectionViewDataSource,PassImformation>
...
- (void)viewDidLoad {
    ...
    self.statuses = [self getModelFromPlistWithFileName:@"collecionStatus.plist"];
    [self getUsers];
    [self layoutView];
}
...
- (void)getUsers
{
    ...
    NSMutableArray* mutArray = [self getDictionaryFromPlistWithFileName:@"collecionStatus.plist"];
